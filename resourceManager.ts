...
function marshallResource(resource: any, resourceName: string): any {
...
function marshallProtobufAny(object: any): any {
  return object.value ? object.value.toString() : null;
}

function makeFilter(ids: string[]): any {
  return toStruct({
    id: {
      $in: ids
    }
