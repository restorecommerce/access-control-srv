...
| obligation | https://github.com/restorecommerce/libs/blob/master/packages/protos/io/restorecommerce/attribute.proto#L5[`io.restorecommerce.attribute.Attribute [ ]`] | optional | list of Obligation attached to rules / policies
| operation_status | https://github.com/restorecommerce/libs/blob/master/packages/protos/io/restorecommerce/status.proto#L23[`io.restorecommerce.status.OperationStatus`] | required | operation status code and message |
|==============================================================================================================================================
